...
const mockExtrato: Transacao[] = [
  ...
  { id: 't-005', data: '2025-10-30', descricao: 'Transferência para Conta Pessoal', valor: -10000.00, tipo: 'TRANSFERENCIA', status: 'PAGO', imovelId: '' },
];

const mockFinanceiroData: FinanceiroData = {
  // KPIs
  receitaLiquidaMes: 15400 - 1500, // Simulação de valores líquidos
  contasAReceberTotal: 3500.00, // Aluguéis de novembro + atrasados
  contasAPagarTotal: 480.00 + 150.00, // Comissão + IPTU
...
export async function fetchFinanceiroData(): Promise<FinanceiroData> {
  console.log('[FinanceiroService] Simulação: Buscando dados financeiros detalhados...');
...
// Crie e cole o código em: src/services/FinanceiroService.ts